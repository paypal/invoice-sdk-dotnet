<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MarkInvoiceAsPaid.aspx.cs"
    Inherits="InvoicingSampleApp.MarkInvoiceAsPaid" %>
...
<body>
    ...
    <h2>
        MarkInvoiceAsPaid API Sample Page</h2>
    <div id="apidetails">
        The MarkInvoiceAsPaid API operation is used to mark an invoice as paid.</div>
    <form id="form2" runat="server" action="InvoiceHandler.ashx">
        <div id="request_form">
            ...
            <div class="params">
                <div class="param_name">
                    Date when the invoice is paid</div>
                <div class="param_value">
        ...
        <div class="submit">
            <input type="submit" name="invoiceBtn" value="MarkInvoiceAsPaid" />
            <br />
        </div>
