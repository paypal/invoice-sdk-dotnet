<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SearchInvoices.aspx.cs"
    Inherits="InvoicingSampleApp.SearchInvoices" %>

<%@ Register TagPrefix="uc" TagName="Permissions" Src="RequestPermission.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PayPal Invoice SDK - SearchInvoices Sample Page</title>
...
<body>
    ...
    <h2>
        SearchInvoices API Sample Page</h2>
    <div id="apidetails">
        The SearchInvoice API operation is used to search for invoices that match given
        search criteria.</div>
    <form id="form2" runat="server" action="InvoiceHandler.ashx">
        ...
        <div class="params">
            ...
            <div class="param_name">
                Status (Provide upto 10 different status types)</div>
            <div class="param_value">
                <select name="status0">
            ...
            <div class="param_name">
                Lowest invoice amount to match</div>
            <div class="param_value">
                <input type="text" name="lowerAmount" value="1.0" />
            </div>
            <div class="param_name">
                Highest invoice amount to match</div>
            <div class="param_value">
        ...
        <div class="submit">
            <input type="submit" name="invoiceBtn" value="SearchInvoices" />
            <br />
        </div>
    </form>
